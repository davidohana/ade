 ...
 */
public class LinuxSyslog3164ParserWithCompAndPid extends LinuxSyslog3164ParserBase {
     ...
     */
    private static final int COMP_GROUP = RFC3164_HEADER_GROUPS + 1;
    private static final int PID_GROUP = RFC3164_HEADER_GROUPS + 2;
    private static final int MSG_GROUP = RFC3164_HEADER_GROUPS + 3;
    
    /**
     * Default constructor to call its parent constructor.
     * @throws AdeException
     */
    public LinuxSyslog3164ParserWithCompAndPid() throws AdeException {
        super();
    }
    /**
     ...
     * @throws AdeException
     */
    public LinuxSyslog3164ParserWithCompAndPid(LinuxAdeExtProperties linuxAdeExtProperties)
            throws AdeException {
